namespace SimpleWars.Terrain
{
    ...
    {
        /* Period parameters */
        // I'm also lowering these to improve the performance for multiple fast pseudo random numbers
        ...
        public uint Seed
        {
            set
            {
                ...
                this.mt[0] = this.seed_ & 0xffffffffU;
                this.mti = 1;
                this.mt[this.mti] = (69069 * this.mt[this.mti - 1]) & 0xffffffffU;

                // I'm stripping of the seed cycles because they really 
                // slow down performance in my case
