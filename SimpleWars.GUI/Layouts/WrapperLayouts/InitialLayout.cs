    ...
    public class InitialLayout : Layout
    {
        ...
        private void InitializeComponents()
        {
            var loginLayoutButton = new Button(
                this.Position + new Vector2(400, 150),
                PointTextures.TransparentPoint,
                new Vector2(200, 30),
                Color.Black,
                2,
                () => { this.activeLayout = this.loginLayout; });

            var loginLayoutButtonTextNode = new TextNode(loginLayoutButton, new Vector2(70, 0), Vector2.One, "Login", SpriteFontManager.Instance.GetFont("Arial_22"), Color.Black);

            loginLayoutButton.TextNode = loginLayoutButtonTextNode;

            var registerLayoutButton = new Button(
                this.Position + new Vector2(620, 150),
                PointTextures.TransparentPoint,
                new Vector2(200, 30),
                Color.Black,
                2,
            ...
            var registerLayoutButtonTextNode = new TextNode(registerLayoutButton, new Vector2(50, 0), Vector2.One, "Register", SpriteFontManager.Instance.GetFont("Arial_22"), Color.Black);
